...
var Freqs = new Float32Array(nFreqs),Mags = new Float32Array(nFreqs),Phases = new Float32Array(nFreqs);
...
function UICallback (event) {
  ...
  for (freqStep=0;freqStep<nFreqs;++freqStep)
    canvasContext.lineTo(canvas.width*freqStep/nFreqs,canvas.height-Mags[freqStep]*90);
